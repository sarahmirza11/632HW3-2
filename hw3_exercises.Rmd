...
est <-read_csv("est.csv")
  ...
  rename(iso = "division_numeric_code") %>% 
    mutate(cp = contraceptive_use_modern * 100) %>% 
...
Weidong helped me in this HW!I wasn't able to get a few of the error messages. Still waiting on an email reply but I needed to submit in case I don't hear anything!
```{r, include= T}
...
https://github.com/sarahmirza11/632HW3-2
